...
def compile_file(file_path):
    ...
    subprocess.run(f"multipass exec manager -- mpicc -o /home/ubuntu/cloud/{file_name} /home/ubuntu/cloud/{full_file_name}", shell=True)
...
def main():
    ...
    parser.add_argument('--n', '-n', type=int, default=-1, help='Number of threads to run the MPI program with (optional)')
